...
class ProjectTest < ActiveSupport::TestCase
  setup do
    ...
    @project          = create(:project, course: @course, owner: @student, supervisor: @lecturer_enrolment)
    @instance         = create(:project_instance, project: @project, supervisor: @lecturer_enrolment, created_by: @student, version: 1)
  end
