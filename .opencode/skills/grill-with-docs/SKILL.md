...
description: Use when the user wants to establish shared understanding, domain vocabulary, or design decisions for a plan or feature in a codebase. Interviews the user about a plan or design until both share one understanding, then writes vocabulary and hard decisions into the repo. Trigger with /grill-with-docs.
---
