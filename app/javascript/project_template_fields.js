document.addEventListener("turbo:load", function () {
  ...
  function createNewFieldHTML(index) {
    return `
      <tr class="field-row group flex flex-col lg:table-row bg-white hover:bg-gray-50 transition-colors relative border-b lg:border-none last:border-b-0" data-field-index="${index}">
        ...
        <td class="block lg:table-cell px-6 py-4 whitespace-nowrap align-top">
          ...
          <div class="relative">
            ...
            <button type="button" class="remove-field hidden lg:group-hover:flex absolute -left-8 top-1.5 p-1 text-gray-400 hover:text-red-600 transition-colors" title="Remove Field">
        ...
        <td class="block lg:table-cell px-6 py-4 align-top">
          ...
          <textarea name="project_template[project_template_fields_attributes][${index}][hint]"
                    ...
                    rows="1"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm resize-y min-h-[38px]"></textarea>
        </td>

        <td class="block lg:table-cell px-6 py-4 whitespace-nowrap align-top">
          <span class="lg:hidden text-xs font-bold text-gray-500 uppercase tracking-wide mb-1 block">Field Type</span>
          <select name="project_template[project_template_fields_attributes][${index}][field_type]" class="field-type-select block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm cursor-pointer">
        ...
        <td class="block lg:table-cell px-6 py-4 align-top">
          ...
          <button type="button" class="remove-field lg:hidden mt-3 inline-flex items-center text-xs text-red-600 hover:text-red-800 font-medium">
            <svg class="mr-1 h-4 w-4 pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" /></svg>
            Remove Field
          </button>
        </td>
      </tr>
